...
def main():
    ...
    parser.add_argument("--waypoints_path", default='./waypoints.csv', help="The path of the waypoints file")
    ...
    try:
        ...
        while True:
            ...
            if state == State.FORWARDING:
                ...
                if dis < DIS_THRESH:
                    print("You have reached the point %s (location: %s)." % (waypoint_idx, WAYPOINTS[waypoint_idx]))
                    waypoint_idx += 1
